...
![Histogram](/Images/BMI/Picture10.png){: width="485" height="343"}) ![Histogram](/Images/BMI/Picture11.png){: width="485" height="343"}  
...
_The residual of the fitted distribution and the fitted model are shown above_  
