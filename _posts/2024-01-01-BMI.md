...
__Figure 1 Histogram of the frequency distribution of the variable BMI__

![Cullen and Frey graph](/Images/BMI/Picture2.png){: width="485" height="343"}
__Figure 2 Cullen and Frey graph__

![](/Images/BMI/Picture3.png){:width="965" height="580"}
__Figure 3 Shows the pdf() of the BM__ &emsp;&emsp;&emsp;&emsp;&emsp;&emsp; __Figure 4 Shows the cdf() of the BMI__
